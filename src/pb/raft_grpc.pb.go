...
type RaftClient interface {
	...
	AppendEntries(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogResponse, error)
}
...
func (c *raftClient) AppendEntries(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogResponse)
...
type RaftServer interface {
	...
	AppendEntries(context.Context, *LogRequest) (*LogResponse, error)
...
func (UnimplementedRaftServer) AppendEntries(context.Context, *LogRequest) (*LogResponse, error) {
...
func _Raft_AppendEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServer).AppendEntries(ctx, req.(*LogRequest))
	}
	return interceptor(ctx, in, info, handler)
}
